...
void loop() {
 ...
 while (mygps.available() > 0) {
    ...
    if (gps.location.isUpdated()) {
      ...
      Firebase.setString(firebaseData, "admin/" + emailadmingps + "/users/" + emailusergps + "/latitude", LatitudeString);
      Firebase.setString(firebaseData, "admin/" + emailadmingps + "/users/" + emailusergps + "/longitude", LongitudeString);
    }
  }
}
